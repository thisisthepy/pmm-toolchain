...
numpy.__loader__.finder.extract_if_changed(os.path.join("llama_cpp", "lib", "libllama.so"))
numpy.__loader__.finder.extract_if_changed(os.path.join("llama_cpp", "lib", "libggml.so"))
